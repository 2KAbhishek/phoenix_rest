defmodule PhoenixRest.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      PhoenixRest.Repo,
      {Ecto.Migrator,
        repos: Application.fetch_env!(:phoenix_rest, :ecto_repos),
        skip: skip_migrations?()},
      {DNSCluster, query: Application.get_env(:phoenix_rest, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: PhoenixRest.PubSub},
      # Start the Finch HTTP client for sending emails
      {Finch, name: PhoenixRest.Finch},
